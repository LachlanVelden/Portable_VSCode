...
async function enable(rpcClient, workspaceService, workspaceAccessControlManager) {
...
class WorkspaceTaskService {
    ...
    async runTask(taskUidOrName, context) {
        ...
        try {
            ...
            if (taskToRun) {
                if (!await this.workspaceAccessControlManager.canPerformOperation(context, WorkspaceTaskService.runTaskOperation, true /* sendTelemetry */)) {
