    ...
    static ensureRuntimeDependenciesAsync(extension) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield installFileExistsAsync())) {
                ...
                return yield util.ExtensionUtil.runWithProgress((progress) => { return downloader.installRuntimeDependenciesAsync(progress); }, { title: 'Downloading dependencies...' });
            }
            else {
...
function isInstallCorrupt(traceSource, manifest) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!manifest) {
            manifest = yield getCompleteManifest();
        }
        ...
        yield Promise.all(fileList.map((fileName) => __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield createHash_1.createHash(path.join(extensionDir, fileName));
...
function getCompleteManifest() {
    return __awaiter(this, void 0, void 0, function* () {
        const extensionDir = path.resolve(__dirname, '../../');
        const externalManifestFile = path.join(extensionDir, 'externalManifest.json');
        const externalManifest = JSON.parse(yield fs.readFile(externalManifestFile, { encoding: 'utf-8' }));
