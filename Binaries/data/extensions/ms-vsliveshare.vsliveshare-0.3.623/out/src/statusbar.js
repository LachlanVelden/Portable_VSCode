...
class StatusBarController {
    constructor(commandEnabledCallback) {
        ...
        session_1.SessionContext.addListener(sessionTypes_1.SessionEvents.StateChanged, (newState, previousState) => __awaiter(this, void 0, void 0, function* () {
            return yield this.onSessionStateChanged(newState);
        }));
        session_1.SessionContext.addListener(sessionTypes_1.SessionEvents.ReadOnlyChanged, () => __awaiter(this, void 0, void 0, function* () {
            if (session_1.SessionContext.State === sessionTypes_1.SessionState.Joined || session_1.SessionContext.State === sessionTypes_1.SessionState.Shared) {
                yield this.onSessionStateChanged(session_1.SessionContext.State);
            }
        }));
    }
...
class SharedState extends CollaborationState {
    ...
    updateUserStatusBarItem(currentUserItem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield util_1.ExtensionUtil.tryRegisterCommand(commandId, () => {
