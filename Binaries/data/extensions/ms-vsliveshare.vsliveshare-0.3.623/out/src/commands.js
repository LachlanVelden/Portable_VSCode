...
class Commands {
    constructor(shareDebugManager, dependencies) {
        ...
        this.removeUserCommandHandler = (item) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.workspaceUserService.removeUserAsync(sessionId);
        });
        ...
        terminalManager_1.enableTerminalManager(this.terminalService);
    }
    ...
    register() {
        ...
        if (!config.get(config.Key.progressShareCommandEnabled)) {
    ...
    startReadOnlyCollaboration() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield vscode.commands.executeCommand('liveshare.start', { access: liveShare_1.Access.ReadOnly });
        });
    }
    startCollaboration(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            new telemetry_1.TelemetryEvent(telemetryStrings_1.TelemetryEventNames.CLICK_SHARE_BUTTON)
                .addProperty('buttonText', statusbar_1.getShareButtonText())
    ...
    startCollaborationHelper(retryIfUnauthorized = true, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (userInfo.accountStatus) {
                ...
                default:
                    ...
                    let workspaceRoots = [util.PathUtil.getPrimaryWorkspaceFileSystemPath()];
                    ...
                    shareTelemetryEvent.addMeasure(telemetryStrings_1.TelemetryPropertyNames.SHARE_WORKSPACE_COUNT_OF_WORKSPACE_FOLDERS, workspaceRoots.length);
                    try {
                        ...
                        yield textSearchService.initAsync();
                    ...
                    yield this.workspaceAccessControlManager().init();
                    if (options && options.access === liveShare_1.Access.ReadOnly) {
                        yield this.workspaceAccessControlManager().setReadOnly(true);
                    }
                    // Share debug manager
                    yield this.shareDebugManager.setShareState(true);
                    yield lspServer.activateAsync(this.workspaceService, this.workspaceAccessControlManager());
                    // Create breakpoint manager instance
                    yield this.createBreakpointManager(true);
                    yield WorkspaceTaskService.enable(this.rpcClient, this.workspaceService, this.workspaceAccessControlManager());
    ...
    copyCollaborationLinkCommandHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentLink = session_1.SessionContext.workspaceSessionInfo.joinUri;
            yield clipboardy_1.write(currentLink);
            yield vscode.window.showInformationMessage('Invite link copied to clipboard! Send it to anyone you trust.');
        });
    }
    ...
    getFeedback() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield config.save(config.Key.sessionCount, sessionCount + 1);
            const goodResponse = '🙂';
            const badResponse = '☹️';
            ...
            if (config.get(config.Key.requestFeedback) && sessionCount % 5 === 0) {
                ...
                switch (qualitativeFeedback) {
                    ...
                    case apatheticResponse:
                        yield config.save(config.Key.requestFeedback, false);
                        break;
                    default:
                        break;
                }
    ...
    joinCollaborationHelper(joinCollaborationLink, options, joinEvent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let firstRootPath = `${Commands.cascadeLauncherScheme}/`;
            ...
            workspaceDefinition.settings = Object.assign({ [Commands.joinWorkspaceIdSettingName]: workspaceInfo.id, [Commands.joinWorkspaceIdFolderSettingName]: workspaceFolder }, joinUtilities_1.JoinUtilities.getBaseWorkspaceSettings());
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                const userInfo = yield this.signIn({
                    ...
                    signInPromptUserActionCallback: (status) => __awaiter(this, void 0, void 0, function* () {
                        if (status === SignInPromptUserAction.Cancel) {
                            ...
                            const result = yield vscode.window.showWarningMessage('You need to sign in before joining the collaboration session.', signInAgainItem);
                ...
                try {
                    ...
                    yield this.accessControlManager().joinCollaboration();
            ...
            this.joinDebugManager = new joinDebugManager_1.JoinDebugManager(this.rpcClient, session_1.SessionContext.workspaceSessionInfo.id, this.fileSystemManager.workspaceProvider, this.debuggerHostService, this.hostAdapterService);
    ...
    leaveCollaboration(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.rpcClient.dispose(new serviceErrors_1.RpcConnectionShutdownError());
                ...
                if (session_1.SessionContext.IsReadOnly) {
                    yield this.fileSystemManager.registerFileSystemProvider(false /* isReadOnly */);
                }
            ...
            yield this.safelyExecute('JoinDebugManager', (this.joinDebugManager && this.joinDebugManager.dispose));
            yield this.safelyExecute('BreakpointManager', (this.breakpointManager && this.breakpointManager.dispose));
            yield this.safelyExecute('WorkspaceTaskClient', WorkspaceTaskClient.disable);
            if (session_1.SessionContext.State === sessionTypes_1.SessionState.Shared) {
            ...
            yield this.safelyExecute('Move to unjoin state', () => {
                session_1.SessionContext.transition(session_1.SessionAction.Unjoin);
            });
            yield this.safelyExecute('Disable collaborator commands', this.disposeCollaboratorCommands);
            yield this.safelyExecute('Unjoin the workspace', () => __awaiter(this, void 0, void 0, function* () {
                if (!skipUnjoin) {
                    yield this.workspaceService.unjoinWorkspaceAsync(workspaceId);
                }
            }));
            yield this.safelyExecute('Execute `beforeLeave`', beforeLeave);
            if (!didSaveUntitled) {
                ...
                yield session_1.SessionContext.extensionContext.workspaceState.update(Commands.joinWorkspaceIdSettingName, undefined);
    ...
    onWorkspaceSessionChanged(e) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (session_1.SessionContext.State === sessionTypes_1.SessionState.Shared) {
                    yield this.workspaceAccessControlManager().onWorkspaceSessionChanged(e);
                }
            }
            catch (e) {
                traceSource_1.traceSource.error(e);
    ...
    summonParticipants() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.window.showInformationMessage('Focus request sent.');
        });
    }
    ...
    unshareServerBySourcePort(item) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!item || (item.sourcePort == null)) {
                return;
            }
            yield this.serverSharingService.stopSharingAsync(item.sourcePort);
            yield vscode.window.showInformationMessage(`Stopped sharing port ${item.sourcePort} in the collaboration session.`);
        });
    }
    openSharedServerInBrowser(item) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!item || (item.sourcePort == null)) {
                return;
            }
    ...
    copySharedServerURL(item) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!item || (item.sourcePort == null)) {
                return;
            }
            yield clipboardy_1.write(`http://localhost:${item.sourcePort}`);
            yield vscode.window.showInformationMessage('The server URL was copied to your clipboard.');
        });
    }
    ...
    setupCollaboratorCommands() {
        return __awaiter(this, void 0, void 0, function* () {
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.pinCommandId, this.pinCommandHandler, this, /* isEditorCommand */ false);
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.pinFromFileTreeExplorerCommandId, this.pinCommandHandler, this, /* isEditorCommand */ false);
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.pinFromActivityBarCommandId, this.pinCommandHandler, this, /* isEditorCommand */ false);
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.unpinCommandId, this.unpinCommandHandler, this, /* isEditorCommand */ true);
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.unpinFromFileTreeExplorerCommandId, this.unpinCommandHandler, this, /* isEditorCommand */ true);
            yield util_1.ExtensionUtil.tryRegisterCommand(Commands.unpinFromActivityBarCommandId, this.unpinCommandHandler, this, /* isEditorCommand */ true);
        });
    }
    pinCommandHandler(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (coEditorCount === 1 && !alwaysShowParticipants) {
                yield session_1.SessionContext.coeditingClient.pin(textEditor, coEditors[0]);
            }
            else if (typeof (args) === 'number') {
                yield session_1.SessionContext.coeditingClient.pin(null, args);
            }
            else if (args && (typeof (args) === 'object') && args.sessionId) {
                yield session_1.SessionContext.coeditingClient.pin(null, args.sessionId);
            }
            else {
    ...
    unpinCommandHandler(textEditor, edit, args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!session_1.SessionContext.coeditingClient) {
                return;
            }
