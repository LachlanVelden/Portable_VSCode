...
exports.dependencies = (function (sessionContext, trace, telemetry) {
    const context = {
        ...
        progressNotifierUtil: lazyLoad(() => new ProgressNotifierUtil_1.ProgressNotifierUtil(sessionContext, context.notificationUtil(), context.contextUtil(), trace.withName('Progress'))),
        ...
        authenticationFlow: lazyLoad(() => new AuthenticationFlow_1.AuthenticationFlow(context.authenticationProvider(), sessionContext, context.browserUtil(), trace.withName('Auth'))),
        ...
        lspServerManager: lazyLoad(() => new LspServerManager_1.LspServerManager(context.workspaceService(), context.workspaceAccessControlManager())),
        workspaceTaskManager: lazyLoad(() => new WorkspaceTaskManager_1.WorkspaceTaskManager(context.rpcClient(), context.workspaceService(), context.workspaceAccessControlManager())),
        coEditingManager: lazyLoad(() => new CoEditingManager_1.CoEditingManager(context.authenticationProvider(), sessionContext, context.sourceEventService(), context.fileService(), context.statusBarController(), context.accessControlManager)),
        ...
        workspaceAccessControlManager: lazyLoad(() => new workspaceAccessControlManager_1.WorkspaceAccessControlManager(context.workspaceAccessControlService(), context.workspaceUserService())),
        ...
        accessControlManager: lazyLoad(() => new accessControlManager_1.AccessControlManager(context.accessControlService(), context.fileSystemManager())),
