...
class JoinDebugManager {
    constructor(rpcClient, workspaceId, workspaceProvider, debuggerHostService, hostAdapterService) {
        ...
        this.onDidReceiveDebugSessionCustomEvent = (eventData) => __awaiter(this, void 0, void 0, function* () {
            if (eventData.event === JoinDebugManager.insufficientAccessExceptionEventType) {
                yield vscode.window.showErrorMessage(eventData.body.Message);
            }
        });
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                this.setLaunchConfigurations(yield this.debuggerHostService.getLaunchConfigurationsAsync());
            }
            catch (error) {
    ...
    */
    ...
    launchRemoteDebugConfiguration(workspaceFolder, debugConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rawDebugConfiguration) {
                ...
                try {
                    yield this.debuggerHostService.launchDebugSessionAsync(remoteDebugConfiguration);
                }
                catch (error) {
                    if (error instanceof vscode_jsonrpc_1.ResponseError && error.code === vsls.ErrorCodes.RemoteLaunchNotEnabled) {
                        yield vscode.window.showInformationMessage(util_1.ExtensionUtil.getString('error.RemoteLaunchNotEnabled'));
                    }
                    else {
                        throw error;
                    }
    ...
    resolveDebugConfiguration(folder, debugConfiguration, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (debugConfiguration.type !== JoinDebugManager.typeJoinDebug) {
                ...
                return yield this.launchRemoteDebugConfiguration(folder, debugConfiguration);
            }
    ...
    joinDebugSession(debugSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.debug.startDebugging(folders ? folders[0] : undefined, this.toDebugConfiguration(debugSession));
        });
    }
