...
(function (TreeItemType) {
    ...
    // terminal
    TreeItemType["LocalTerminal"] = "localterminal";
...
class FileTreeExplorerProvider {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (element.contextValue) {
                case TreeItemType.Participants:
                    return yield this.getParticipantsChildren();
                case TreeItemType.Servers:
                    return yield this.getServersChildren();
                case TreeItemType.Terminals:
                    return yield this.getTerminalsChildren();
                default:
                    return [];
            }
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let profileKey of participantIds) {
                ...
                if (sessionId !== this.sessionContext.coeditingClient.clientID) {
                    result.push(yield this.getParticipantRow(sessionId, participant));
                }
            }
    ...
    getServersChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sharedServers = (this.sessionContext.coeditingClient.isOwner)
                ? yield this.serverSharingService.getSharedServersAsync()
                : yield this.portForwardingService.getSharedServersAsync();
            for (let server of sharedServers) {
                result.push(yield this.getServerRow(server, this.sessionContext.coeditingClient.isOwner));
            }
            return (result.length === 0)
    ...
    getTerminalsChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = [];
            if (!this.terminalService) {
                return result;
            }
            const sharedTerminals = yield this.terminalService.getRunningTerminalsAsync();
            for (let terminal of sharedTerminals) {
                result.push(yield this.getTerminalRow(terminal, this.sessionContext.coeditingClient.isOwner));
            }
            return (result.length === 0)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return [
                new FileTreeExplorerItemCommon({
                    ...
                    label: `Participants (${participantsIds.length - 1})`
                }),
                new FileTreeExplorerItemCommon({
    ...
    getChildren(element) {
        return __awaiter(this, void 0, void 0, function* () {
            if (element) {
                return yield this.getElementChildren(element);
            }
            return yield this.getDefaultRootChildren();
        });
    }
    ...
    getServerRow(sharedServer, isLocalServer) {
        return __awaiter(this, void 0, void 0, function* () {
            const row = new ServerFileTreeExplorerItem({
                sourcePort: sharedServer.sourcePort,
                type: (isLocalServer)
                ...
                command: {
                    ...
                    arguments: [{ sourcePort: sharedServer.sourcePort }]
                }
            });
            return row;
        });
    }
    getTerminalRow(sharedTerminal, isLocalTerminal) {
        return __awaiter(this, void 0, void 0, function* () {
            const { name, readOnlyForGuests } = sharedTerminal.options;
            const clearName = (name || '').replace('[Shared]', '');
            const row = new TerminalFileTreeExplorerItem({
                ...
                command: {
                    ...
                    arguments: [{ id: sharedTerminal.id }]
                }
            });
            return row;
        });
    }
    getParticipantRow(sessionId, participant) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // participant icon
            const iconBundle = yield UserIconsProvider_1.userIconProvider.getIconByUserId(sessionId);
            let iconPath;
            if (iconBundle) {
                const { coeditingClient } = this.sessionContext;
                const followedUsers = coeditingClient.getUsersBeingFollowed();
