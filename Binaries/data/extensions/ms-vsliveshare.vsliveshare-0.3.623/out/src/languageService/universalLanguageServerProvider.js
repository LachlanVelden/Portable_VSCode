...
class UniversalLanguageServerProvider {
    ...
    initAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.rpcClient.addRequestMethodWithContext(UniversalLanguageServerProvider.SERVICE_NAME + '.request', (requestMessage, coeditingInfo, context, token) => __awaiter(this, void 0, void 0, function* () {
                return yield this.requestAsync(requestMessage, coeditingInfo, context, token);
            }));
    ...
    requestAsync(requestMessage, coeditingInfo, context, token) {
        return __awaiter(this, void 0, void 0, function* () {
