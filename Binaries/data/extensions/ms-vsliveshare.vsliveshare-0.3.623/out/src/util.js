 ...
 */
exports.findFilesAsync = (root, dir, filter) => __awaiter(this, void 0, void 0, function* () {
    let results = [];
    let children = [];
    try {
...
exports.getModificationTime = (filePath) => __awaiter(this, void 0, void 0, function* () {
    const fileStats = yield exports.statAsync(filePath);
...
class ExtensionUtil {
    ...
    static tryRegisterCommand(command, callback, thisArg, isEditorCommand = false, force = false) {
        return __awaiter(this, void 0, void 0, function* () {
 ...
 */
exports.getPromiseState = (p) => __awaiter(this, void 0, void 0, function* () {
    if (!p) {
        return PromiseStatus.NotAPromise;
    }
    const t = {};
    return yield Promise.race([p, t]).then((v) => {
        return (v === t)
