...
class LiveShareApi {
    ...
    share(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield vscode.commands.executeCommand(command, options);
        });
    }
    join(link, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.sendInvokeCommandTelemetryEvent(command, options);
            yield vscode.commands.executeCommand(command, link, options);
        });
    }
    end() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    shareService(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!sharedService) {
                const connection = yield privateContext.client.ensureConnectionAsync();
                ...
                if (this.session.role === liveShare_1.Role.Host) {
                    try {
                        yield privateContext.workspaceService.registerServicesAsync([name], vsls.WorkspaceServicesChangeType.Add);
                    }
                    catch (e) {
                        this.trace.error(e);
                        throw e;
    ...
    unshareService(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sharedService && sharedService.isServiceAvailable) {
                try {
                    yield privateContext.workspaceService.registerServicesAsync([name], vsls.WorkspaceServicesChangeType.Remove);
                }
                catch (e) {
                    this.trace.error(e);
                    throw e;
    ...
    static getSessionAccess(state) {
        ...
        return (state === sessionTypes_1.SessionState.Shared ? liveShare_1.Access.Owner :
            state === sessionTypes_1.SessionState.Joined ? liveShare_1.Access.ReadWrite : liveShare_1.Access.None);
    }
    /**
    ...
    onShared(changedServices) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sharedServiceNames.length > 0) {
                try {
                    yield privateContext.workspaceService.registerServicesAsync(sharedServiceNames, vsls.WorkspaceServicesChangeType.Add);
                }
                catch (e) {
                    this.trace.error(e);
