...
(function (Key) {
    ...
    Key["requestFeedback"] = "requestFeedback";
    ...
    Key["progressShareCommandEnabled"] = "progressShareCommandEnabled";
    // MEMENTO SETTINGS
...
const privateSettings = [
    ...
    Key.progressShareCommandEnabled
];
...
exports.featureFlags = {
    ...
    increaseGuestLimit: false,
    textSearch: true,
    autoShareTerminal: false,
    showExplorer: true,
    accessControl: true,
};
const experimentalFeatures = {
    ...
    increaseGuestLimit: true,
    textSearch: true,
    autoShareTerminal: true,
    showExplorer: true,
    accessControl: true,
};
...
function initAsync(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield mc.MementoConfig.initAsync(context);
