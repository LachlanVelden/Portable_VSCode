...
class TerminalWorkerProvider {
    ...
    createTerminal(info, renderer, trace) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (renderer) {
                ...
                renderer.onDidChangeMaximumDimensions(d => {
                    ...
                    resizeTimer = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        clearTimeout(resizeTimer);
                        resizeTimer = null;
                        try {
                            yield this.terminalService.resizeTerminalAsync(info.id, d.columns, d.rows);
                        }
                        catch (e) {
                ...
                terminal = yield renderer.terminal;
            ...
            vscode.window.onDidCloseTerminal((t) => __awaiter(this, void 0, void 0, function* () {
                if (t === terminal) {
                    ...
                    if (session_1.SessionContext.State === sessionTypes_1.SessionState.Shared) {
                        ...
                        try {
                            yield this.terminalService.resizeTerminalAsync(info.id, 0, 0);
                        }
                        catch (_a) {
    ...
    pipeTerminalStdio(endpoint, renderer, trace) {
        return __awaiter(this, void 0, void 0, function* () {
            let disposables = [];
            ...
            try {
                ...
                while (!cts.token.isCancellationRequested) {
                    const text = yield endpoint.readStringAsync(cts.token);
                    if (text === null) {
                        break;
                    }
                    renderer.write(text);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                dataServer = net.createServer((socket) => {
                    terminal.onDidWriteData(s => writeDataQueue = writeDataQueue.then(() => __awaiter(this, void 0, void 0, function* () {
                        yield socket.write(s);
                    })), null, registrations);
                    socket.on('data', (data) => {
                ...
                terminalInfo = yield this.terminalService.startTerminalAsync(options);
            }
            catch (e) {
            ...
            const disposeTerminalWorker = () => __awaiter(this, void 0, void 0, function* () {
                this.workers.delete(terminalInfo.id);
                registrations.forEach(d => d.dispose());
                try {
                    if (!this.terminalService.client.isDisposed) {
                        yield this.terminalService.stopTerminalAsync(terminalInfo.id);
                    }
                }
                catch (_a) { }
                try {
